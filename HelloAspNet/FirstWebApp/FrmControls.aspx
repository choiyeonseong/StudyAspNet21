...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID="LnkMicrosoft" Text="마이크로소프트" runat="server" NavigateUrl="https://www.microsoft.com" />

            <asp:Image ID="ImgChange" runat="server" ImageUrl="~/images/ASP-NET-Banners-01.png" />
            <asp:Button ID="BtnChange" runat="server" OnClick="BtnChange_Click" Text="이미지 변경" />
            <br />
