...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <asp:LinkButton ID="BtnLink" runat="server" OnClick ="BtnLink_Click">네이버</asp:LinkButton><br />
            <asp:ImageButton ID="BtnImage" runat="server" AlternateText="글쓰기" ToolTip="글쓰기" OnClick="BtnImage_Click" ImageUrl="~/images/btn_post.gif"/>
        </div>
    </form>
</body>
</html>
