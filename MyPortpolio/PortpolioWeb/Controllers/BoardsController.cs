...
namespace PortpolioWeb.Controllers
{
    public class BoardsController : Controller
    {
        ...
        public BoardsController(PortpolioWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            var pageSize = 5;  // 조정 필요

            var board = await _context.Board.ToPagedListAsync(pageNumber, pageSize); // X.PagedList Method
