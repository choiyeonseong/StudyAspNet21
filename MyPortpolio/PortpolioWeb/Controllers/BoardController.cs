...
namespace PortpolioWeb.Controllers
{
    public class BoardController : Controller
    {
        ...
        public BoardController(PortpolioWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            var pageSize = 10;  // 조정 필요

            var boards = await _context.Board.ToPagedListAsync(pageNumber, pageSize); // X.PagedList Method
