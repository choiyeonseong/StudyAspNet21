...
namespace DotNetNote.Models
{
    public class DbRepository
    {
        ...
        public int SaveOrUpdate(Note n, BoardWriteFormType formType)
        {
            ...
            switch (formType)
            {
                case BoardWriteFormType.Write:
                    ...
                    // 저장프로시저 결과값 1(succeed) or 0(fail)
        ...
        {
            return con.Query<int>(@"Select Count(*) 
                                      From NoteComments 
        ...
        {
            string sql =
                @"SELECT TOP 3 Id, BoardId, Opinion, PostDate 
                    FROM NoteComments 
                   Order By Id Desc";
